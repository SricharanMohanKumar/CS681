...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try (Stream<String> lines = Files.lines(path)) {
            ...
            var minprice = price.parallelStream()
            ...
            var maxprice = price.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(13)))
                    .max()
                    .orElse(Double.NaN);
            ...
            var avgprice = price.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(13)))
                    .average()
                    .orElse(Double.NaN);
            ...
            System.out.println("\n------------------------------\n Data processing 2");
            List<List<String>> filteredDatacrime = matrix.parallelStream()
                    .skip(1)
                    .sorted(Comparator.comparingDouble(row -> Double.parseDouble(row.get(0))))
                    .limit((int) Math.ceil(matrix.size() / 10))
                    .collect(Collectors.toList());

            List<List<String>> filteredDatateacher = matrix.parallelStream()
                    .skip(1)
            ...
            minprice = commonData.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(13)))
                    .min()
                    .orElse(Double.NaN);
            System.out.println(minprice);
            ...
            maxprice = commonData.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(13)))
                    .max()
                    .orElse(Double.NaN);
            System.out.println(maxprice);
            ...
            avgprice = commonData.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(13)))
                    .average()
                    .orElse(Double.NaN);
            System.out.println(avgprice);
            ...
            List<List<String>> sortedtax = matrix.parallelStream()
                    .skip(1)
            ...
            avgprice = sortedtax.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(13)))
                    .average()
                    .orElse(Double.NaN);
            System.out.println(avgprice);
            ...
            System.out.println(price.parallelStream().count());
            System.out.println("-------------------------------\nData processing 4");

            System.out.println("\nTop 5 old houses by age");
            List<List<String>> oldhouse = matrix.parallelStream()
                    .skip(1)
            ...
            List<List<String>> newhouse = matrix.parallelStream()
                    .skip(1)
                    .sorted(Comparator.comparingDouble(row -> Double.parseDouble(row.get(6))))
                    .limit(5)
                    .collect(Collectors.toList());
            ...
            avgprice = newhouse.parallelStream()
            ...
            avgprice = oldhouse.parallelStream()
                    .mapToDouble(row -> Double.parseDouble(row.get(6)))
                    .average()
                    .orElse(Double.NaN);
            System.out.println(avgprice);
